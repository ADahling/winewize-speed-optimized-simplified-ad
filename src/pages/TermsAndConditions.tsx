    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Terms & Conditions for WINE WIZE LLC</h1>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. Age Restriction</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">5. User Conduct and Prohibited Activities</h2>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li>Attempting to bypass or circumvent the age gate or any other security measures.</li>
              ...
              <li>Engaging in any activity that disrupts or interferes with the Service or the servers and networks connected to the Service.</li>
              ...
              <li>Using any automated system, including without limitation "robots," "spiders," "offline readers," etc., to access the Service in a manner that sends more request messages to the WINE WIZE LLC servers than a human can reasonably produce in the same period by using a conventional web browser.</li>
            </ul>
